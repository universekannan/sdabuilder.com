...
if (isset($_POST['submit'])) {
    ...
    $date=date("Y-m-d");
        ...
        $stmt = $conn->prepare("INSERT INTO payment (project_id,description,amount,date,user_id,states) VALUES (?,?,?,?,?,?)");
        $stmt->bind_param("ssssss", $project_id,$description,$amount,$date,$user_id,$states);
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <center><h4><b>Other Expense</h4></center>
                        </div>
