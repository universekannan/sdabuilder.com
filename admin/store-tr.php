...
if (isset($_POST['submit1'])) {
    ...
    $qty = $_POST['qty'];
       ...
       header("location: store-approval.php");
            ...
            <div class="row"><br>
                <div class="col-lg-12">
                    <div class="panel panel-default">
                      ...
                      $sql3 = "select a.*,b.equipment_name from supervisor a,equipment b where a.equ_id=b.id and a.project_id='1'";
                                ...
                                <div class="col-md-12 text-center">
                                    ...
                                    <a href="store-equipment.php" class="btn btn-info">Back</a>
                                </div>
                                        </form>
