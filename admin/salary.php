        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
					...
					$sql = "select a.*,b.full_name from salary a,users b where a.user_id=b.id and a.staff_id=$id and a.date>='$from_date' and a.date<='$to_date' ORDER BY a.date DESC";
                        ...
                        ?>
                            ...
                            <td>Total</td>
                             <td>
							<?php
		                 $sql2 = "select COUNT(hours) as hours from salary where hours<>'a' and staff_id=$id and date>='$from_date' and date<='$to_date' GROUP BY staff_id ";
                        ...
                        while ($row2 = mysqli_fetch_assoc($result2)) {
							...
							<?php
		                 $sql2 = "select sum(amount) as amount from salary where staff_id=$id and date>='$from_date' and date<='$to_date' GROUP BY staff_id ";
                        //$sql2 = "SELECT SUM(balance) FROM payment";
                        $result2 = mysqli_query($conn, $sql2);
                        while ($row2 = mysqli_fetch_assoc($result2)) {
							...
							<?php
		                 $sql2 = "select sum(payed) as payed from salary where staff_id=$id and date>='$from_date' and date<='$to_date' GROUP BY staff_id ";
                        //$sql2 = "SELECT SUM(balance) FROM payment";
                        $result2 = mysqli_query($conn, $sql2);
                        while ($row2 = mysqli_fetch_assoc($result2)) {
                            ?><?php echo $row2['payed']; ?>
							...
							<td>
							<?php
		                 $sql2 = "select sum(balance) as balance from salary where staff_id=$id and date>='$from_date' and date<='$to_date' GROUP BY staff_id ";
                        //$sql2 = "SELECT SUM(balance) FROM payment";
                        $result2 = mysqli_query($conn, $sql2);
                        while ($row2 = mysqli_fetch_assoc($result2)) {
