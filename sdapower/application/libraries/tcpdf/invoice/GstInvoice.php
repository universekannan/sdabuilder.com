		...
		$tbl .='<table>
		            <tbody>';
		            	...
		            	$tbl .='<tr nobr="true" class="text-bold">';
		                	$tbl .='<td colspan="3" style="width:'.($colWidthSize['sl_no']+($colWidthSize['description'] -10)+$colWidthSize['hsn']+$colWidthSize['gst_rate']).'%">';
		                	$tbl .=$this->CI->lang->line("total");
		                	$tbl .='</td>';

		                	$tbl .='<td colspan="3" style="width:'.($colWidthSize['qty']+6).'%">';
		                	$tbl .='';
		                	$tbl .='</td>';
		                ...
		                if(!empty($coupon_code)){
			                $tbl .='<tr nobr="true">
			                	<td colspan="4" style="width:'.($colWidthSize['sl_no']+($colWidthSize['description']-10)+$colWidthSize['hsn']+$colWidthSize['gst_rate']+$colWidthSize['qty']).'%">';
